    ...
    return (
        <div className={styles.header__wrapper}>
            <header className={styles.header}>
                ...
                <Account/>
                <div className={styles.hamburgerMenu} onClick={() => setShowHamburgerMenu(prev => !prev)}>
                    {showHamburgerMenu ? <IoClose/> : <GiHamburgerMenu/>}
                </div>
            </header>
            <nav className={classNames(styles.mobileNav, showHamburgerMenu && styles.mobileNav__active)}>
                <NavigateLink to="#about" text="About us"/>
                <NavigateLink to="#contact" text="Contact us"/>
                <NavigateLink to="#team" text="The team"/>
            </nav>
